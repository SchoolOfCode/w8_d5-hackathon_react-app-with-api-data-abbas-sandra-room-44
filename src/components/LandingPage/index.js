...
export function LandingPage(){
    ...
    return(
        <div id ="main">
            <div id="right">
            <h1><span id="My">My</span><span id="Pokemon">Pokemon</span></h1>
            <p id="para">MyPokemon is the number one social media site for Pokemon fans.</p>
            <button id="button" to="/">Explore Site</button>
            </div>
            <div id="left">
            <img id="pokeImg"src={url}/>
            <h2 id="name" style={hStyle}>{name}</h2>
            </div>
        </div>
    )
}
